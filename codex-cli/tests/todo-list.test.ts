...
describe("TodoList", () => {
  ...
  describe("Basic Operations", () => {
    ...
    it("should get tasks by status", async () => {
      ...
      await todoList.add("Task 3", "medium");
  ...
  describe("Dependencies", () => {
    ...
    it("should prevent completing blocked tasks", async () => {
      ...
      await expect(todoList.updateStatus(id2, "completed")).rejects.toThrow(
        "Cannot update status. Task is blocked by",
      );
    });
    ...
    it("should detect circular dependencies", async () => {
      ...
      await expect(todoList.addDependency(id1, id3)).rejects.toThrow(
  ...
  describe("Progress Tracking", () => {
    ...
    it("should get actionable tasks", async () => {
      ...
      await todoList.add("Independent task", "medium");
