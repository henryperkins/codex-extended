...
export const toolsInfoTool: FunctionTool = {
  type: "function",
  name: "tools_info",
  description: "Discover available tools and learn how to use them. Get tool lists, descriptions, and examples.",
  strict: false,
  parameters: {
    type: "object",
    properties: {
      action: {
        ...
        description: "Action to perform: list all tools, describe a specific tool, or get examples"
      },
      tool_name: {
        type: "string",
        description: "Name of the tool (required for describe/examples actions)"
      }
    },
    required: ["action"],
...
const TOOL_REGISTRY: Record<string, ToolInfo> = {
  shell: {
    ...
    parameters: '{"command": ["cmd", "arg1", "arg2"], "workdir"?: "path", "timeout"?: 60000}'
  },
  todo_list: {
    name: "todo_list",
    category: "organization",
    description: "Manage tasks with priorities, dependencies, and progress tracking",
    parameters: '{"action": "add|list|complete|start|...", "content"?: "task", "id"?: "task-id", "priority"?: "low|medium|high"}'
  },
  scratchpad: {
    name: "scratchpad",
    category: "memory",
    description: "Store and retrieve notes, plans, and intermediate results",
    parameters: '{"action": "write|read|update|delete|summarize", "content"?: "text", "category"?: "note|plan|result", "id"?: "entry-id"}'
  },
  fetch_url: {
    name: "fetch_url",
    category: "web",
    description: "Fetch and process content from URLs with optional synopsis generation",
    parameters: '{"url": "https://example.com"}'
  },
  web_search: {
    name: "web_search",
    category: "web",
    description: "Search the web and get structured results with URLs, titles, and snippets",
  ...
  tools_info: {
    ...
    parameters: '{"action": "list|describe|examples", "tool_name"?: "tool_name"}'
  }
};

const TOOL_EXAMPLES: Record<string, Array<{description: string, example: any}>> = {
  todo_list: [
    {
      description: "Add a new high-priority task",
      example: { action: "add", content: "Fix critical bug in authentication", priority: "high" }
    },
    {
    ...
    },
    {
      ...
      example: { action: "complete", id: "task-123", notes: "Fixed by updating dependencies" }
    },
    {
  ...
  scratchpad: [
    {
      ...
      example: { action: "write", content: "Found issue in line 42 of auth.js", category: "note" }
    },
    {
      description: "Save analysis results",
      example: { action: "write", content: "Performance bottleneck: database queries", category: "result" }
    },
    {
 ...
 */
export async function handleToolsInfo(args: any): Promise<string> {
  ...
  switch (action) {
    ...
    case "describe": {
      ...
      return JSON.stringify({
        ...
        hint: tool_name in TOOL_EXAMPLES ? "Use action='examples' to see usage examples" : undefined
      }, null, 2);
    }
    ...
    default:
      return JSON.stringify({
        ...
        valid_actions: ["list", "describe", "examples"]
      });
  }
}